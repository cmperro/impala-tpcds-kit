...
do
   ...
   then
      ...
      cd /home/cperro/impala-tpcds-kit/tpcds-gen; echo $password | kinit $selected_user; hadoop jar target/tpcds-gen-1.0-SNAPSHOT.jar -d s3a://${bucket}/data/tpcds_300_text -p 20 -s 300; hdfs dfs -rm -r -skipTrash s3a://${bucket}/data/tpcds_300_text
